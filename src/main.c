...
int main(int argc, char **argv) {
  ...
  while ( ( c = Extra_UtilGetopt( argc, argv, "XYZNJKLIBDRWTCGVPOAQSMFUEabcdegvh" ) ) != EOF )
  {
      switch ( c )
      {
      case 'X':
