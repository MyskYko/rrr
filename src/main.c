...
int main(int argc, char **argv) {
  ...
  while ( ( c = Extra_UtilGetopt( argc, argv, "XYZNJKLBDRWTCGVPOAQSMFUEabcdegvh" ) ) != EOF )
  {
      switch ( c )
      {
      case 'X':
