...
int main(int argc, char **argv) {
  ...
  while ( ( c = Extra_UtilGetopt( argc, argv, "XYZNJKLBDRWTCGVPOAQSFUabcdegvh" ) ) != EOF )
  {
      switch ( c )
      {
      case 'X':
