...
namespace rrr {
  ...
  public:
    BddMspfAnalyzer();
    BddMspfAnalyzer(Ntk *pNtk, Parameter *pPar);
    ~BddMspfAnalyzer();
  ...
  template <typename Ntk>
  std::function<void(Action)> BddMspfAnalyzer<Ntk>::CreateActionCallback() {
  ...
  template <typename Ntk>
  BddMspfAnalyzer<Ntk>::BddMspfAnalyzer(Ntk *pNtk, Parameter *pPar) :
