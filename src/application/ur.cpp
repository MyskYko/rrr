...
#include "scheduler/rrrUrScheduler.h"
#include "optimizer/rrrUrOptimizer.h"
...
int main(int argc, char **argv) {
  cxxopts::Options options("ur", "structure-space reachability analysis");
  ...
  */
  ...
  std::vector<rrr::AndNetwork *> vNtks = rrr::PerformInt<rrr::AndNetwork, rrr::UrScheduler, rrr::UrOptimizer, rrr::Partitioner>(&ntk, &Par);
